        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4 class="modal-title" id="BrtBollaTitle">
                    <span>{l s='BOLLA N.' mod='mpbrtinfo'} <strong>{$bolla->getDatiSpedizione()->getSpedizioneId()}</strong> {l s='DEL' mod='mpbrtinfo'} <strong>{$bolla->getDatiSpedizione()->getSpedizioneData()}</strong></span>
                </h4>
