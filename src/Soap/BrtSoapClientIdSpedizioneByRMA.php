...
class BrtSoapClientIdSpedizioneByRMA extends BrtSoapClient
{
    ...
    public function getSoapIdSpedizioneByRMA($customer_id = '', $rma = '')
    {
        $response = [];
        $spedizione_id = '';

        $request = new \stdClass();
        $request->RIFERIMENTO_MITTENTE_ALFABETICO = $rma;
